/*1660444883,,JIT Construction: v1006023208,en_US*/
...
try {
    (window.FB && !window.FB.__buffer) || (function() {
        ...
        for (var i = 0; i < sandboxSafelist.length; i++) {
            ...
            with(this) {
                ...
                __d("sdk.XFBML.CustomerChatNew", ["ChatPluginSDKPreLoggingUtils", "DOMEventListener", "IframePluginClass", "Log", "MPNExplicitUserInteractions", "MPNLocalState", "QueryString", "UrlMap", "getFacebookOriginForTarget", "performanceAbsoluteNow", "sdk.Content", "sdk.DOM", "sdk.DialogUtils", "sdk.Event", "sdk.UA", "sdk.WebStorage", "sdk.XD", "sdk.XFBML.CustomerChatWrapper", "sdk.cp.Actions", "sdk.cp.Animation", "sdk.cp.Constants", "sdk.cp.Storage", "sdk.createIframe"], (function(a, b, c, d, e, f, g) {
                    ...
                    a = function(a) {
                        ...
                        function b(b, c, e, f) {
                            ...
                            g.$CustomerChat15 = !1;
                            g.show = function(a) {
                                a === void 0 && (a = !0), g.$CustomerChat15 = !1, g.$CustomerChat1 != null && d("sdk.DOM").setStyle(g.$CustomerChat1, "display", "inline"), a && g.$CustomerChat29(g.$CustomerChat4), d("sdk.Event").fire("customerchat.show"), g.$CustomerChat33("show")
                            };
                            g.hide = function() {
                                g.$CustomerChat15 = !0, g.$CustomerChat1 != null && d("sdk.DOM").setStyle(g.$CustomerChat1, "display", "none"), g.$CustomerChat28(g.$CustomerChat4), d("sdk.Event").fire("customerchat.hide"), g.$CustomerChat33("hide")
                            };
                            g.showDialog = function() {
                                g.$CustomerChat1 != null && d("sdk.DOM").setStyle(g.$CustomerChat1, "display", "inline"), g.$CustomerChat29(g.$CustomerChat4), g.$CustomerChat33("showDialog")
                            };
                            g.hideDialog = function() {
                                g.$CustomerChat28(g.$CustomerChat4), g.$CustomerChat33("hideDialog")
                            };
                            g.update = function(a) {
                                var b;
                        ...
                        e.$CustomerChat20 = function(a) {
                            ...
                            this.$CustomerChat3 = c("sdk.createIframe")({
                                ...
                                onload: function() {
                                    d("ChatPluginSDKPreLoggingUtils").preLogging("chat_plugin_sdk_icon_iframe_load", b.params), b.$CustomerChat2 = j, b.$CustomerChat25(), b.$CustomerChat26(), window.setTimeout(function() {
                                        d("sdk.DOM").remove(i)
                                    }, 100)
                                }
                            });
                            ...
                            this.$CustomerChat8 = c("sdk.createIframe")({
                                ...
                                onload: function() {
                                    b.$CustomerChat9 = k, b.$CustomerChat25(), b.$CustomerChat26()
                                }
                            });
                            ...
                            this.$CustomerChat6 = c("sdk.createIframe")({
                                ...
                                onload: function() {
                                    b.$CustomerChat7 = l, b.$CustomerChat25(), b.$CustomerChat26()
                                }
                            });
                            ...
                            if (!f) {
                                ...
                                this.$CustomerChat10 = c("sdk.createIframe")({
                                    ...
                                    onload: function() {
                                        b.$CustomerChat11 = m, b.$CustomerChat25(), b.$CustomerChat26()
                                    }
                                });
                        ...
                        e.$CustomerChat21 = function(a) {
                            ...
                            if (a && !this.$CustomerChat14) {
                                ...
                                e != c("sdk.cp.Constants").path.landingPage && e != c("sdk.cp.Constants").path.bubble && this.$CustomerChat27()
                            }
                            this.$CustomerChat15 && this.hide()
                        };
                        e.$CustomerChat22 = function(a) {
                            a = a.shouldHide;
                            a === "true" ? this.$CustomerChat28(this.iframe) : this.$CustomerChat29(this.iframe)
                        };
                        e.$CustomerChat23 = function(a) {
                            a = a.shouldHide;
                            a === "true" ? this.$CustomerChat30(this.$CustomerChat10) : this.$CustomerChat31(this.$CustomerChat10)
                        };
                        e.getParams = function() {
                            return {
                                allow_guests: "bool",
                        ...
                        e.$CustomerChat19 = function(a) {
                            var b;
                            this.$CustomerChat32((b = this.$CustomerChat2) != null ? b : "", a)
                        };
                        e.$CustomerChat18 = function(a) {
                            var b;
                            this.$CustomerChat32((b = this.$CustomerChat5) != null ? b : "", a)
                        };
                        e.$CustomerChat33 = function(a) {
                            this.$CustomerChat18({
                ...
                __d("sdk.CustomTags", ["sdk.XFBML.Comments", "sdk.XFBML.CommentsCount", "sdk.XFBML.CustomerChatWrapper", "sdk.XFBML.LWIAdsCreation", "sdk.XFBML.LWIAdsInsights", "sdk.XFBML.LoginButton", "sdk.XFBML.MessengerCheckbox", "sdk.XFBML.MessengerMessageUsWrapper", "sdk.XFBML.Save", "sdk.XFBML.SendToMessengerWrapper", "sdk.XFBML.ShareButton", "sdk.XFBML.Video"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    a = {
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1006023208","namespace":"FB","message":"' + e.message + '"}}');
