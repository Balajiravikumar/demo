...
(function(a) {
    ...
    function ha() {
        ...
        b.length > 0 && (P = setTimeout(Z()(ha, "_checkFbtVirtualModuleTimeout"), Q));
        c.length > 0 && S.apply(null, [
            ["FBLogger"],
            function(a) {
                a("binary_transparency", "vmod_timeout").warn("The following virtual modules are taking over %s ms to be defined: %s...", Q, c.join(",").slice(0, 300))
            }
        ])
    }
    ...
    function ia(a, b) {
        ...
        for (var c = 0; c < b.length; c++)
            if (b[c] === "fbt") {
                ...
                !(d in e) && !(d in O) && (O[d] = z());
                b.push(d);
                P || (P = setTimeout(Z()(ha, "_checkFbtVirtualModuleTimeout"), Q));
                break
            }
    }
    ...
    function R(b, c, e, g, h, i, l) {
        ...
        n.context = h;
        n.special = g;
        (n.nonJSDeps || ta(n)) && (n.nonJSDeps = !1, L(n));
        U(n);
        if (d.length > 0) {
            var o = d;
            d = [];
            b = a.ScheduleJSWork ? a.ScheduleJSWork : wa;
            b(function() {
                if (w) {
    ...
    function Z() {
        var b = a.TimeSlice && a.TimeSlice.guard ? a.TimeSlice.guard : wa;
        return function() {
...
__d("Promise", ["ErrorPubSub", "PromiseImpl", "err", "setTimeoutAcrossTransitions"], (function(a, b, c, d, e, f) {
    ...
    var i;
    d && !!a.Promise ? i = a.Promise : i = b("PromiseImpl");
    i.allSettled || (i.allSettled = function(a) {
        if (!Array.isArray(a)) return i.reject(new TypeError("Promise.allSettled must be passed an array."));
        var b = Array(a.length),
            c = function(c, d) {
                var e = a[c];
                d = typeof e === "object" && e !== null && typeof e.then === "function";
                b[c] = d ? new i(function(a, b) {
                    e.then(function(b) {
                        a({
                            status: "fulfilled",
                            value: b
    ...
    i.prototype["finally"] || (i.prototype["finally"] = function(a) {
    ...
    i.prototype.done || (i.prototype.done = function(a, c) {
    ...
    function n(e, f) {
        ...
        return b("regeneratorRuntime").async(function(h) {
            while (1) switch (h.prev = h.next) {
                case 0:
                    if (!(!c("ExecutionEnvironment").canUseDOM || i.has(e))) {
                        h.next = 2;
                        break
                    }
                ...
                case 11:
                    g = h.t0;
                    d("MakeHasteTranslationsMap").setBatch(g.translations);
                    g.virtual_modules.forEach(function(b) {
                        return a.define(b, {})
                    });
                    h.next = 20;
                    break;
                case 16:
                    h.prev = 16, h.t1 = h["catch"](2), i["delete"](e), c("FBLogger")("binary_transparency", "translation_download_error").catching(h.t1).warn("Unable to download and process translation map. Url: %s", f);
                case 20:
                case "end":
                    return h.stop()
            }
    ...
    function Q(a, c, d, e) {
        ...
        a.onerror = h.bind(void 0, function() {
            ...
            G.maybeScheduleRetry(f, function() {
                ...
                v.set(c, h), b("FBLogger")("bootloader").warn("JS loading error [%s] at %s | time: %s | retries: %s | concurrency: %s", c, f, h - g, G.getNumRetriesForSource(f), t.size - u.size), b("NetworkStatus").reportError(), e()
            })
        })
    }
...
__d("PluginMessage", ["CSS", "DOM", "DOMEventListener"], (function(a, b, c, d, e, f, g) {
    function a() {
        d("DOMEventListener").add(window, "message", function(a) {
            if (/\.facebook\.com$/.test(a.origin))
                if (/^FB_POPUP:/.test(a.data)) {
                    var b = JSON.parse(a.data.substring(9));
                    "reload" in b && /^https?:/.test(b.reload) && document.location.replace(b.reload)
                } else if (h().test(a.data)) {
                b = JSON.parse(a.data.substring(24));
                "type" in b && (b.type === "send_to_messenger" && i(b))
            }
        })
    }
    ...
    function i(a) {
        ...
        b != null && e != null && f != null && g != null && h != null && (a.can_personalize === !0 && a.connected === !0 ? (d("CSS").show(b), d("CSS").hide(e), i(g, a.profile_photo), i(h, a.profile_name), d("CSS").show(f)) : (d("CSS").hide(b), d("CSS").show(e), d("CSS").hide(f)));
